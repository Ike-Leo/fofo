...
import { LogOut, LayoutDashboard, Package, Settings, ClipboardList, ShoppingBag, Users } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={() => signOut()}
                            className="text-slate-500 hover:text-red-600 transition-colors p-2 rounded-md hover:bg-slate-50"
                            title="Sign out"
                        >
                            <LogOut size={18} />
                        </button>
